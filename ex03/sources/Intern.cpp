...
/*   Updated: 2025/07/25 23:23:35 by ytop             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Intern::Intern ()
{
	std::cout << G_CLR << "Constructor for " << B_CLR << "Intern" << RESET << std::endl;
}
...
Intern::Intern (const Intern &copy)
{
	*this = copy;
	...
	std::cout << G_CLR << "Copy const  for " << B_CLR << "Intern" << RESET << std::endl;
}

Intern::~Intern()
{
	std::cout << R_CLR << "Destructor  for " << B_CLR << "Intern" << RESET << std::endl;
}
...
Intern &Intern::operator=(const Intern &copy)
{
	...
	std::cout << Y_CLR << "Copy assignment operator for " << B_CLR << "Intern" << RESET << std::endl;
